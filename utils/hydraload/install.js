...
var XpiInstaller = {
	...
	extFullName: 'HydraLoad', // The name displayed to the user (don't include the version)
	extShortName: 'hydraload', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.2',
	extAuthor: 'Gaubatz Patrick',
